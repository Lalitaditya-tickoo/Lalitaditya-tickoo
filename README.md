...
<!--
<div align="center">
  <img src="https://raw.githubusercontent.com/Lalitaditya-tickoo/Lalitaditya-tickoo/main/assets/banner.png" width="100%" alt="banner"/>
</div>
-->
...
const lalitaditya = {
  pronouns:    "he/him",
  location:    "India 🇮🇳",
  role:        "AI/ML Researcher + Full Stack Dev",
  university:  "SRM University",
  year:        "B.Tech CS — 4th Semester",
  
  currentlyBuilding: [
    "🔬 Underwater Marine Litter Detection (Research Paper)",
    "🏥 CXR-ReportGen — Auto Radiology from X-Rays",
    "🧠 ScholarMind — RAG-powered Research Assistant"
  ],

  stack: {
    weapons:    ["Python", "PyTorch", "React", "Next.js"],
    ai:         ["Computer Vision", "Transformers", "LoRA"],
    backend:    ["FastAPI", "Node.js", "MongoDB"],
    learning:   "MLOps + distributed training"
  },

  vibe:    "shipping research > shipping hype",
  mantra:  "papers don't write themselves 💀",
  askMe:   "anything CV / deep learning / papers"
};
```
...
<!-- ⚡ TECH ARSENAL -->
## <img src="https://media.giphy.com/media/iY8CRBdQXODJSCERIr/giphy.gif" width="35"> `ARSENAL.sys`
...
### ⚡ Full Stack
<img src="https://skillicons.dev/icons?i=js,ts,react,nextjs,nodejs,express,tailwind,html,css&theme=dark" />

### 🛠️ Backend & DB
<img src="https://skillicons.dev/icons?i=fastapi,mongodb,mysql,firebase,postgres,redis&theme=dark" />

### 🔧 DevTools
<img src="https://skillicons.dev/icons?i=git,github,vscode,linux,bash,docker,postman&theme=dark" />
...
<!-- ⚡ FEATURED RESEARCH -->
## <img src="https://media.giphy.com/media/W5fBGlD2qiXP8IpQ0M/giphy.gif" width="35"> `RESEARCH.log`
...
> **Query-Guided Multi-Resolution Transformer for Underwater Instance Segmentation**

Comparison of **Mask R-CNN** vs **Mask2Former** on 8,000+ annotated underwater images across 10 categories. Features underwater-specific augmentation pipeline, differential learning rates, mixed precision training.
...
### 🏥 CXR-ReportGen
> **End-to-end automated radiology report generation from chest X-rays**

**EfficientNet-B3** (visual encoder) + **BioGPT** (medical text decoder) with **LoRA** fine-tuning, trained on the IU X-Ray dataset. Generates clinical-grade findings and impressions.

`EfficientNet-B3` · `BioGPT + LoRA`
...
### 🧠 ScholarMind
> **RAG-powered research assistant with cited answers for scientific literature**

Built with **FastAPI** + **ChromaDB** + **sentence-transformers** + **Claude API** + **React**. Semantic search over papers with source-grounded responses.
...
<!-- ⚡ WAKATIME WEEKLY CODING STATS (UNCOMMENT AFTER LEVEL-UP #2) -->
<!--
<div align="center">
...
<!-- Contribution Snake -->
<div align="center">
  <img src="https://raw.githubusercontent.com/Lalitaditya-tickoo/Lalitaditya-tickoo/output/github-contribution-grid-snake-dark.svg" width="100%" />
</div>

---

<!-- ⚡ HOLOPIN BADGES (UNCOMMENT AFTER LEVEL-UP #3) -->
<!--
## <img src="https://media.giphy.com/media/hvRJCLFzcasrR4ia7z/giphy.gif" width="35"> `BADGES.earned`

<div align="center">
  <a href="https://holopin.io/@Lalitaditya-tickoo">
    <img src="https://holopin.me/Lalitaditya-tickoo" alt="Holopin badge board" />
  </a>
</div>
...
<!-- ⚡ CURRENT FOCUS / NOW PLAYING -->
## <img src="https://media.giphy.com/media/QssGEmpkyEOhBCb7e1/giphy.gif" width="35"> `NOW.playing`
...
researching:  Transformer-based segmentation
reading:      Papers (arxiv.org my beloved)
building:     Research portfolio for conferences
target:       CIS 2026 → ADCIS 2026 → ICCAIML'26
mood:         "the paper won't write itself" 😤
```
...
<!-- ⚡ SPOTIFY NOW-PLAYING WIDGET (UNCOMMENT AFTER LEVEL-UP #4) -->
<!--
<div align="center">
...
<!-- ⚡ CONNECT SECTION -->
## <img src="https://media.giphy.com/media/SUrdzUxSHVmXUDT5pH/giphy.gif" width="35"> `CONNECT.me`
